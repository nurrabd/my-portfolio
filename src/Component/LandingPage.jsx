            ...
            <div className="container" >
                ...
                <div className="row">
                    <div className="col-6  border-danger " Style="height:100px; width:100%; " align="right">
                        <a className="fab fa-linkedin fa-5x" href="https://www.linkedin.com/in/nurhusein-abdulkader-185865112/"></a>
                    </div>
                    <div className="col-6    border-danger "  Style="height:100px; width:100%" align="left">
                        <a className="fab fa-github fa-5x " href="https://github.com/nurrabd"></a>
                    </div>
                </div>
                <div Style="height:60px"></div>
